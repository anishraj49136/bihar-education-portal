...
// जांचें कि उपयोगकर्ता लॉग इन है और वह DDO है
checkUserType('ddo');
...
try {
    ...
    // अगर क्वेरी फेल हो जाए, तो हम मान लेंगे कि status कॉलम नहीं है
    $has_status_column = false;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'update_attendance') {
    ...
    header("Location: ddo_dashboard.php?month=$selected_month&year=$selected_year&udise_code=$udise_code");
    exit;
}
...
// केवल तभी status कॉलम जोड़ें जब यह टेबल में मौजूद हो
if ($has_status_column) {
    $sql .= ", a.status";
}
 ...
 $sql .= ", s.name as school_name, s.udise_code
        ...
        AND (t.class LIKE '%1-5%' OR t.class LIKE '%6-8%')"; // DDO फ़िल्टर
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="p-4 text-center">
            ...
            <p class="mb-0">DDO डैशबोर्ड</p>
        </div>
        <hr class="text-white">
        <ul class="nav flex-column">
            <li class="nav-item"><a class="nav-link active" href="ddo_dashboard.php"><i class="fas fa-tachometer-alt"></i> डैशबोर्ड</a></li>
        ...
        <form method="post" action="" id="attendanceForm">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">उपस्थिति विवरणी (कक्षा 1-8)</h5>
                    <div>
